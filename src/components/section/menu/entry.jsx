  ...
  if (name) {
    return (
      ...
      >
        ...
        <div className={classNames('column')} itemProp="offers" itemScope="" itemType="https://schema.org/Offer">
            ...
            prices.map(({ id, price, notes }) => {
              ...
              return (
                <div className={classNames('columns', 'is-mobile')} key={id}>
                  {notes && (
                    <div
                      className={classNames('column', 'is-8', 'price-notes', 'has-text-right')}
                  ...
                  {value > 0 && (
                    <div
                      className={classNames('column', 'price', 'is-4', { 'is-offset-8': !notes })}
                      itemProp="price"
